...
(
    ...
    `seats` SMALLINT DEFAULT 3 NOT NULL,
    `classes` TINYINT DEFAULT 1 NOT NULL,
    `icao` VARCHAR(4) NOT NULL,
    `wtc` TINYINT DEFAULT 1 NOT NULL,
    `engine_type` TINYINT DEFAULT 0 NOT NULL,
    `engine_count` TINYINT DEFAULT 1 NOT NULL,
    `flight_range` SMALLINT DEFAULT 3000 NOT NULL,
    `cruising_speed` SMALLINT DEFAULT 120 NOT NULL,
