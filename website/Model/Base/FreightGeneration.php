...
/**
 * Base class that represents a row from the 'freight_generations' table.
 *
 *
 *
* @package    propel.generator.Model.Base
*/
abstract class FreightGeneration implements ActiveRecordInterface
{
    /**
     * TableMap class name
     */
    const TABLE_MAP = '\\Model\\Map\\FreightGenerationTableMap';
    ...
    /**
     * Compares this with another <code>FreightGeneration</code> instance.  If
     * <code>obj</code> is an instance of <code>FreightGeneration</code>, delegates to
     * <code>equals(FreightGeneration)</code>.  Otherwise, returns <code>false</code>.
     *
     ...
     *
     * @return $this|FreightGeneration The current object, for fluid interface
     */
    ...
    public function setAirportId($v)
    {
        ...
        if ($this->airport_id !== $v) {
            $this->airport_id = $v;
            $this->modifiedColumns[FreightGenerationTableMap::COL_AIRPORT_ID] = true;
        }
    ...
    public function setCapacity($v)
    {
        ...
        if ($this->capacity !== $v) {
            $this->capacity = $v;
            $this->modifiedColumns[FreightGenerationTableMap::COL_CAPACITY] = true;
        }
    ...
    /**
     * Set the value of [every] column.
     *
     * @param int $v new value
     * @return $this|\Model\FreightGeneration The current object (for fluent API support)
     */
    public function setEvery($v)
    {
        if ($v !== null) {
            $v = (int) $v;
        }
        ...
        if ($this->every !== $v) {
            $this->every = $v;
            $this->modifiedColumns[FreightGenerationTableMap::COL_EVERY] = true;
        }
    ...
    public function hydrate($row, $startcol = 0, $rehydrate = false, $indexType = TableMap::TYPE_NUM)
    {
        try {
            ...
            $col = $row[TableMap::TYPE_NUM == $indexType ? 4 + $startcol : FreightGenerationTableMap::translateFieldName('Every', TableMap::TYPE_PHPNAME, $indexType)];
            $this->every = (null !== $col) ? (int) $col : null;
            $this->resetModified();
            ...
            return $startcol + 5; // 5 = FreightGenerationTableMap::NUM_HYDRATE_COLUMNS.

        } catch (Exception $e) {
            throw new PropelException(sprintf('Error populating %s object', '\\Model\\FreightGeneration'), 0, $e);
        }
    }
    ...
    public function reload($deep = false, ConnectionInterface $con = null)
    {
        ...
        $dataFetcher = ChildFreightGenerationQuery::create(null, $this->buildPkeyCriteria())->setFormatter(ModelCriteria::FORMAT_STATEMENT)->find($con);
     ...
     * @return void
     * @throws PropelException
     * @see FreightGeneration::setDeleted()
     * @see FreightGeneration::isDeleted()
     */
    public function delete(ConnectionInterface $con = null)
    {
        ...
        $con->transaction(function () use ($con) {
            $deleteQuery = ChildFreightGenerationQuery::create()
    ...
    public function save(ConnectionInterface $con = null)
    {
        ...
        return $con->transaction(function () use ($con) {
            ...
            if ($ret) {
                ...
                $this->postSave($con);
                FreightGenerationTableMap::addInstanceToPool($this);
            } else {
                $affectedRows = 0;
            }
    ...
    protected function doInsert(ConnectionInterface $con)
    {
        ...
        if ($this->isColumnModified(FreightGenerationTableMap::COL_EVERY)) {
            $modifiedColumns[':p' . $index++]  = 'every';
        }

        $sql = sprintf(
            'INSERT INTO freight_generations (%s) VALUES (%s)',
            ...
            foreach ($modifiedColumns as $identifier => $columnName) {
                switch ($columnName) {
                    ...
                    case 'capacity':
                        ...
                        break;
                    case 'every':
                        $stmt->bindValue($identifier, $this->every, PDO::PARAM_INT);
                        break;
                }
            }
            $stmt->execute();
    ...
    {
        $pos = FreightGenerationTableMap::translateFieldName($name, $type, TableMap::TYPE_NUM);
    ...
    public function toArray($keyType = TableMap::TYPE_PHPNAME, $includeLazyLoadColumns = true, $alreadyDumpedObjects = array(), $includeForeignObjects = false)
    {
        ...
        if (isset($alreadyDumpedObjects['FreightGeneration'][$this->hashCode()])) {
            return '*RECURSION*';
        }
        $alreadyDumpedObjects['FreightGeneration'][$this->hashCode()] = true;
     ...
     *                TableMap::TYPE_COLNAME, TableMap::TYPE_FIELDNAME, TableMap::TYPE_NUM.
     *                Defaults to TableMap::TYPE_PHPNAME.
     * @return $this|\Model\FreightGeneration
     */
     ...
     * @param string $keyType The type of keys the array uses.
     *
     * @return $this|\Model\FreightGeneration The current object, for fluid interface
     */
    ...
    public function buildCriteria()
    {
        ...
        if ($this->isColumnModified(FreightGenerationTableMap::COL_EVERY)) {
            $criteria->add(FreightGenerationTableMap::COL_EVERY, $this->every);
        }
    ...
    {
        $criteria = ChildFreightGenerationQuery::create();
        $criteria->add(FreightGenerationTableMap::COL_AIRPORT_ID, $this->airport_id);
    ...
    {
        $validPk = null !== $this->getAirportId();

        $validPrimaryKeyFKs = 1;
        $primaryKeyFKs = [];

        //relation freight_generations_fk_d3c970 to table airports
        if ($this->aAirport && $hash = spl_object_hash($this->aAirport)) {
            $primaryKeyFKs[] = $hash;
        } else {
    ...
    /**
     * Generic method to set the primary key (airport_id column).
     *
     ...
     * objects.
     *
     * @param      object $copyObj An object of \Model\FreightGeneration (or compatible) type.
     ...
     *
     * @param  boolean $deepCopy Whether to also copy all rows that refer (by fkey) to the current row.
     * @return \Model\FreightGeneration Clone of current object.
     * @throws PropelException
     */
    ...
    public function getAirport(ConnectionInterface $con = null)
    {
        if ($this->aAirport === null && ($this->airport_id !== null)) {
            ...
            $this->aAirport->setFreightGeneration($this);
        }
    ...
    {
        return (string) $this->exportTo(FreightGenerationTableMap::DEFAULT_STRING_FORMAT);
    }
